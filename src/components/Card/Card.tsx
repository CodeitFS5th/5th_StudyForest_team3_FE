...
export default function Card({
    ...
    const settings = {
        ...
        pointBg: isPictureBg ? 'bg-black/10 border border-black/50' : 'bg-white/30 border border-black/10',
    ...
    return (
        <div
            ...
            <p className={`${settings.streakText} mt-1 xl:mt-[10px] text-[12px] xl:text-[14px]`}>{streak}일째 진행 중</p>
            <p className={`${settings.descriptionText} mt-3 xl:mt-[30px] text-[12px] xl:text-[14px]`}>{description}</p>
        </div>
    )
}